...
// PositionAddUpdateBase 创建/修改内容基类
type PositionAddUpdateBase struct {
	PicUrl    string
	Link      string
	GoodsName string
	GoodsId   uint
...
// PositionAddInput 创建内容
type PositionAddInput struct {
	PositionAddUpdateBase
}

// PositionAddOutput 创建内容返回结果
type PositionAddOutput struct {
