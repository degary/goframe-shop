...
// Create 创建内容
func (s *sPosition) Add(ctx context.Context, in model.PositionAddInput) (out model.PositionAddOutput, err error) {
	// 不允许HTML代码
	...
	return model.PositionAddOutput{PositionId: int(lastInsertID)}, err
}
